...
public class SimpleUserTransaction implements UserTransaction {
	...
	public SimpleUserTransaction(Connection theConnection) {
	...
	public void setTransactionTimeout(int iTimeOut) throws javax.transaction.SystemException {
		setTransactionTimeout(iTimeOut);
	}
}
